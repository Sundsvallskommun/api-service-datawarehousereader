...
class CustomerDetailsEntityTest {
    ...
    void testNoDirtOnCreatedBean() {
        Assertions.assertThat(CustomerDetailsEntity.create()).hasAllNullFieldsOrPropertiesExcept("customerId","customerCategoryID", "customerChangedFlg", "installedChangedFlg");
        Assertions.assertThat(new CustomerDetailsEntity()).hasAllNullFieldsOrPropertiesExcept("customerId","customerCategoryID", "customerChangedFlg", "installedChangedFlg");
    }
