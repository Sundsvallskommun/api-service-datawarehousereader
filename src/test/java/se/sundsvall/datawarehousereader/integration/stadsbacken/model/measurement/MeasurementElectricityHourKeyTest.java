...
class MeasurementElectricityHourKeyTest {
	@BeforeAll
	static void setup() {
	...
	@Test
	void testBean() {
		assertThat(MeasurementElectricityHourKey.class, allOf(
	...
	void testNoDirtOnCreatedBean() {
		assertThat(new MeasurementElectricityHourKey()).hasAllNullFieldsOrProperties();
	}
}
