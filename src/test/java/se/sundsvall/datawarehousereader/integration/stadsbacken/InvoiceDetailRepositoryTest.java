...
class InvoiceDetailRepositoryTest {
	...
	void getInvoiceDetailsForSeveralInvoicesNoMatch() {
		assertThat(repository.findAllByInvoiceNumberIn(List.of(999999999L))).isEmpty();
	}

	@Test
	void getInvoiceDetailsForSeveralInvoices() {
		final var details = repository.findAllByInvoiceNumberIn(List.of(139345995L, 766763197L));
