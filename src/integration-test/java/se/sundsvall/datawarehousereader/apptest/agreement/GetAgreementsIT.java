...
class GetAgreementsIT extends AbstractAppTest {
	...
	void test01_getAgreementsByCustomerNumber() {
		setupCall()
			.withServicePath("/2281/agreements?customerNumber=634212")
			.withHttpMethod(GET)
	...
	void test02_getAgreementsByPartyId() {
		setupCall()
			.withServicePath("/2281/agreements?partyId=336EC35A-3335-4FA3-B792-60061222B0E9")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
	...
	void test05_getWithPageLargerThanResult() {
		setupCall()
			.withServicePath("/2281/agreements?partyId=8B718423-8840-4CE5-AB95-642DD876C887&page=2")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
	...
	void test06_getPageWithCustomValues() {
		setupCall()
			.withServicePath("/2281/agreements?category=DISTRICT_HEATING&limit=1&page=5")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
	...
	void test07_getAgreementsByPartyIdAndMultipleCategories() {
		setupCall()
			.withServicePath("/2281/agreements?partyId=65E78C52-B2E1-42DD-8D42-828A94E5BAFF&category=ELECTRICITY&category=DISTRICT_HEATING")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
