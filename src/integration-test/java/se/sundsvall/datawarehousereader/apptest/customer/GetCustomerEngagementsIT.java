...
class GetCustomerEngagementsIT extends AbstractAppTest {
	...
	void test01_getByCustomerNumber() {
		setupCall()
			.withServicePath("/2281/customer/engagements?customerNumber=600606")
			.withHttpMethod(GET)
	...
	void test02_getByOrganizationNumber() {
		setupCall()
			.withServicePath("/2281/customer/engagements?organizationNumber=5564786647")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
	...
	void test03_getByOrganizationName() {
		setupCall()
			.withServicePath("/2281/customer/engagements?organizationName=Sundsvall Energi AB")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
	...
	void test04_getPrivateCustomerByPartyId() {
		setupCall()
			.withServicePath("/2281/customer/engagements?partyId=10e69eb7-3cb4-442f-8cdb-2e998080dbb1")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
	...
	void test07_getEnterpriseCustomerByPartyId() {
		setupCall()
			.withServicePath("/2281/customer/engagements?partyId=70933c1c-2094-44e6-9abe-57b8a3c0ecd9")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
	...
	void test08_getByMultiplePartyIds() {
		setupCall()
			.withServicePath("/2281/customer/engagements?partyId=70933c1c-2094-44e6-9abe-57b8a3c0ecd9&partyId=318b7ec8-aab8-41e2-82f5-796bdd5cebf2&partyId=10e69eb7-3cb4-442f-8cdb-2e998080dbb1")
			.withHttpMethod(GET)
			.withExpectedResponseStatus(OK)
			.withExpectedResponse(RESPONSE_FILE)
			.sendRequestAndVerifyResponse();
