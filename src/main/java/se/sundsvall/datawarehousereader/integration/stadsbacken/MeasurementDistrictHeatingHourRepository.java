...
public interface MeasurementDistrictHeatingHourRepository extends PagingAndSortingRepository<MeasurementDistrictHeatingHourEntity, Long>, JpaSpecificationExecutor<MeasurementDistrictHeatingHourEntity> {
