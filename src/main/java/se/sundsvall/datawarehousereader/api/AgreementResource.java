...
@RestController
@Validated
@RequestMapping("/{municipalityId}/agreements")
...
class AgreementResource {
	...
	@Operation(summary = "Get agreements", description = "Resource returns all agreements matching provided search parameters", responses = {
	...
	ResponseEntity<AgreementResponse> getAgreements(
		@Parameter(name = "municipalityId", description = "Municipality id", example = "2281") @ValidMunicipalityId @PathVariable final String municipalityId,
		@Valid AgreementParameters searchParams) {

		return ok(agreementService.getAgreements(municipalityId, searchParams));
	}
}
